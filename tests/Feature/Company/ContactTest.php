...
class ContactTest extends TestCase
{
        ...
        $response->assertJSON([
            'results' => [
                [
                    ...
                    'alt_email'     => $contacts[0]['alt_email'],
                    'alt_phone'     => $contacts[0]['alt_phone'],
                ...
                [
                    ...
                    'alt_email'     => $contacts[1]['alt_email'],
                    'alt_phone'     => $contacts[1]['alt_phone'],
    ...
    public function testListWithFilter()
    {
        ...
        $response = $this->json('GET', route('list-contacts', [
            ...
            'conditions' => json_encode([
                ...
                [
                    'field' => 'contacts.alt_email',
                    'operator' => 'EQUALS',
                    'inputs' => [ $contact->alt_email ]
                ],
                [
                    'field' => 'contacts.alt_phone',
                    'operator' => 'IN',
                    'inputs' => [ $contact->alt_phone ]
                ]
            ])
        ]);
    ...
    public function testCreateContactFailsForExisingEmail()
    {
        ...
        $response->assertStatus(400);
        $response->assertJSON([
            'error' => 'Duplicate exists matching field alt_email'
        ]);
    }
    ...
    public function testCreateContactFailsForExisingPhone()
    {
        ...
        $response->assertStatus(400);
        $response->assertJSON([
            'error' => 'Duplicate exists matching field alt_phone'
        ]);
    }
    ...
    public function testUpdateContactFailsForExisingEmail()
    {
        ...
        $body       = [
            'alt_email'     => $updateData->alt_email,
            'first_name'    => $updateData->first_name,
            'last_name'     => $updateData->last_name,
            'email'         => $updateData->email,
            'phone'         => $updateData->phone,
    ...
    public function testUpdateContactFailsForExisingPhone()
    {
        ...
        $body       = [
            ...
            'email' => $updateData->email,
            'phone' => $updateData->phone,
            'alt_phone' => $updateData->alt_phone,
            'city' => $updateData->city,
            'state' => $updateData->state,
            'zip' => $updateData->zip,
        ];
