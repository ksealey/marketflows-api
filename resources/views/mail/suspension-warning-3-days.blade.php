...
@section('content')
    <p>
        ...
        <br/><br/>
        <span class="bold">If any statements go unpaid, you will no longer be able to receive calls or messages in 4 days. All numbers associated with your account will be released in 7 days.</span>
        <span class="closing">
            Thank you,<br/>
